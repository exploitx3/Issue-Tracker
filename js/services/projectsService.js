app.factory('projectsService', [
    ...
    function ($http, $q, authService, baseServiceUrl) {
        ...
        function getAllProjectsByLeadId(leadId) {
            var defer = $q.defer();
            var request = {
                method: 'GET',
                url: baseServiceUrl + '/projects?filter=Lead.Id="' + leadId + '"&pageSize=9999999&pageNumber=1',
                headers: authService.getAuthHeaders()
            };
            $http(request).success(function (data) {
                defer.resolve(data);
        ...
        function getAllProjectsWithParams(params) {
            var defer = $q.defer();
            var request = {
                method: 'GET',
        ...
        return {
            ...
            getAllProjectsWithParams: getAllProjectsWithParams,
